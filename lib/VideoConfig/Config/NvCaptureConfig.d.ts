 ...
 *  \endif
*/
export declare class NvTimePair {
    /*! \if ENGLISH
     *
 ...
 *  \endif
*/
export declare enum NvCaptureMenuItem {
    ...
    dualtype = "capture_menu_dual_type"
}
/*! \if ENGLISH
 *
 *  \brief Bottom menu
 ...
 *  \endif
*/
export declare enum NvCaptureBottomMenuItem {
 ...
 *  \endif
*/
export declare class NvCaptureConfig {
    /*! \if ENGLISH
     *
